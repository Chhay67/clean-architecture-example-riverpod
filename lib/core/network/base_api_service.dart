...
//       //printMe('RefreshToken:${AppConstant.REFRESH_TOKEN}');
//
...
//         // printMe("AppTokenRemainingRefreshToken :${JwtDecoder.getRemainingTime(AppConstant.REFRESH_TOKEN!)}");
//         // printMe("AppTokenExpirationDateRefreshToken :${JwtDecoder.getExpirationDate(AppConstant.REFRESH_TOKEN!)}");
//         // printMe("AppTokenExpirationDateRefreshToken :${AppConstant.TOKEN_EXPIRE!}....${DateTime.now().microsecondsSinceEpoch}");
//
...
//         }
//         httpOption.headers!['Authorization'] = "bearer ${AppConstant.USER_TOKEN}";
//       }
//       if (customToken != null) {
...
//     } on ServerResponseException catch (exception, stackTrace) {
//       await Sentry.captureException(exception, stackTrace: stackTrace);
...
//   printMe("Http Log: Server error :=> ${response.requestOptions.path}:=> $exception");
...
//   printMe("Exception caught [${error.runtimeType}][$path]: ${error.toString()}");
...
//         errorMessage = "${error.response!.statusCode}: ${ErrorMessage.SERVER_ERROR}";
//       } else {
//         errorMessage = "${error.response!.statusCode}: ${ErrorMessage.UNEXPECTED_ERROR}";
//       }
//     }
//     return errorMessage;
//     //Json convert error
